...
public class TomcatManager implements ITomcatManager {
    ...
    public String start() throws TomcatManagerException {
        ...
        LOG.info("Start tomcat at " + user.getHomeFolder() + "/latest/tomcat");
        
        int exitVal = 1;
        
        try {
            
            ProcessBuilder pb = new ProcessBuilder(user.getHomeFolder() + "/tomcat/latest/bin/startup.sh");
            Map<String, String> env = pb.environment();
            env.put("JAVA_HOME", "/System/Library/Frameworks/JavaVM.framework/Versions/1.6.0/Home");
            env.put("CATALINA_HOME", user.getHomeFolder() + "/tomcat/latest");
